...
class JumpingTest(Node):
    def __init__(self,
                ...
                name_folder_test2try = 'VIDEO_test_2023_09_21__08_53_35', #'test_q0_bimbi_2023_10_17__17_39_31', # 'VIDEO_test_q0_bimbi_2023_09_05__16_26_31', # 'VIDEO_test_2023_09_05__16_19_05', # 'VIDEO_test_q0_bimbi_2023_09_05__16_26_31', # ''
        ...
        self.q_final_gradino = [-0.86, -1.5] ## già radianti 
        self.amplitude_des = 1.15 # 1.08
    ...
    def hold_callback(self):
        ...
        for i in range(len(self.jnt_names)):
            ...
            msg.kp_scale.append(3.0)
            msg.kd_scale.append(3.0)
            msg.effort.append(0.0)
...
def main(args=None):
    ...
    node = JumpingTest(node_name="Test_jump_18_10_2023_019_q0_23", test_name='test_2023_09_05__16_19_05_00')    
